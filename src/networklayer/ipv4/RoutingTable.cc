...
const IPRoute *RoutingTable::findBestMatchingRoute(const IPv4Address& dest) const
{
...
const IPRoute *RoutingTable::findRoute(const IPv4Address& target, const IPv4Address& netmask,
