...
void EtherMACBase::calculateParameters(bool errorWhenAsymmetric)
{
    ...
    if (dataratesDiffer)
    {
        ...
        // FIXME translate:
        // Ha futas kozben allitjak at a datarate-et, akkor azt mindenkeppen ket kulon ertesiteskent
        // kapjuk meg: kulon a tx es rx channelre. Ha valtozik valamelyik, akkor utana a kovetkezo
        // esemenynel ellenorizni kell, hogy mindket channel azonos ertekre lett-e allitva
