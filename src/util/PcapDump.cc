...
void PcapDump::dump(const char *label, const char *msg)
{
     std::ostream& out = *outp;
...
void PcapDump::dumpIPv4(bool l2r, const char *label, IPDatagram *dgram, const char *comment)
{
#ifdef WITH_IPv4
...
void PcapDump::dumpIPv6(bool l2r, const char *label, IPv6Datagram *dgram, const char *comment)
{
#ifdef WITH_IPv6
    cMessage *encapmsg = dgram->getEncapsulatedPacket();
...
void PcapDump::tcpDump(bool l2r, const char *label, TCPSegment *tcpseg, const std::string& srcAddr, const std::string& destAddr, const char *comment)
{
#ifdef WITH_TCP_BASE
     std::ostream& out = *outp;
